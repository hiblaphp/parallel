...
describe('Promise Combinators Integration', function () {
    ...
    test('Promise::all: rejects immediately if one task fails', function () {
        $promises = [
            parallel(function () {
                usleep(100000);
    ...
    test('Promise::race: resolves with the fastest task', function () {
    ...
    test('Promise::timeout: cancels task if it takes too long', function () {
